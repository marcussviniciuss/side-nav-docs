...
const HeaderPage = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-extrabold mb-4">🧩 Header</h1>
      <h2 className="text-sm font-semibold text-pink-600 uppercase mb-2">Comece por aqui</h2>
      <h3 className="text-2xl font-bold mb-4">Passo 1 - Introdução</h3>
      <p className="mb-6 text-gray-700 leading-relaxed">
        Aprenda a configurar e personalizar o header na plataforma Carrinho Digital para melhorar a navegação e a experiência do usuário.
      </p>
      <h3 className="text-xl font-semibold mb-3">📌 Por que é importante?</h3>
      <p className="mb-6 text-gray-800 leading-relaxed">
        O header fornece acesso rápido a funcionalidades principais, melhorando a usabilidade do site.
      </p>
      <h3 className="text-xl font-semibold mb-3">🎯 O que você vai aprender?</h3>
      <ul className="list-disc list-inside mb-8 text-gray-800">
        <li>Configuração do header</li>
        <li>Personalização de elementos</li>
        <li>Integração com outras partes da aplicação</li>
      </ul>
